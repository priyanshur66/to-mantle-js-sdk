...
exports.MantleExplorer = void 0;
const axios_1 = __importDefault(require("axios"));
const config_1 = __importDefault(require("../config"));
class MantleExplorer {
    constructor() {
        this.baseUrl = `${config_1.default.MANTLE_LIT_SERVER_API_BASE_URL}/explorer/mantle`;
    }
...
exports.MantleExplorer = MantleExplorer;
